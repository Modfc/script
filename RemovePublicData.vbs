...
baseFolder = "C:\\Users\\Netloan_User\\temp"
...
' Delete the contents of "C:\Users\Netloan_User\temp\My Downloads"
destinationFolder = "C:\\Users\\Netloan_User\\temp\\My Downloads"
...
' Empty the contents of "Z:\My Download" into "C:\Users\Netloan_User\temp\My Downloads"
...
startupFolder = "C:\\Users\\Netloan_User\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup"
scriptPath = WScript.ScriptFullName

' Check if the script is already in the custom Startup folder
If Not objFSO.FileExists(startupFolder & "\\RemovePublicData.vbs") Then
    objFSO.CopyFile scriptPath, startupFolder & "\\RemovePublicData.vbs", True
End If
